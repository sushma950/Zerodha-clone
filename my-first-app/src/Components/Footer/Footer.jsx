    ...
    <Background>
        <Box>
            <FlexBox>
                <div>
                    <div>
                        <img width='150px' src='https://zerodha.com/static/images/logo.svg' alt='logo'/>
                    </div>
                    <div>
                        <img width='15px' src='https://img.icons8.com/android/2x/phone.png' alt='tel'/><Number>{` +91 80 4718 1888`}</Number>
                    </div>
                    <NormalFont>
                    ...
                    <div>
                        <SocialMedia width='15px' src='https://img.icons8.com/android/2x/twitter.png' alt='twitter'/>
                        <SocialMedia width='15px' src='https://img.icons8.com/android/2x/facebook-new.png' alt='facebook'/>
                        <SocialMedia width='15px' src='https://img.icons8.com/metro/2x/instagram-new.png' alt='instagram'/>
                        <SocialMedia width='15px' src='https://img.icons8.com/android/2x/linkedin.png' alt='linkedin'/>
