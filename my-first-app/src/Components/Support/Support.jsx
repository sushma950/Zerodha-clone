  ...
  return (
    <div>
      ...
      <Bottom>
        ...
        <Bottomflex>
          <Icondiv>
            <Bottomicon src="https://img.icons8.com/pastel-glyph/2x/plus.png" alt="plus" />
          ...
          <Icondiv>
            <Bottomicon src="https://img.icons8.com/plumpy/2x/user-male-circle.png" alt="user" />
          ...
          <Icondiv>
            <Bottomicon src="https://img.icons8.com/fluent-systems-filled/2x/bar-chart.png" alt="trade" />
          ...
          <Icondiv>
            <Bottomicon src="https://img.icons8.com/ios/2x/folder-invoices--v2.png" alt="funds" />
            <span>Funds</span>
          ...
          <Icondiv>
            <Bottomicon src="https://img.icons8.com/ios/2x/investment-portfolio.png" alt="console" />
            <span>Console</span>
            <div>Reports</div>
            <div>Ledger</div>
            <div>Profile</div>
          ...
          <Icondiv>
            <Bottomicon src="https://cdn4.iconfinder.com/data/icons/money-153/42/money-10-128.png" alt="coin" />
            <span>Coin</span>
